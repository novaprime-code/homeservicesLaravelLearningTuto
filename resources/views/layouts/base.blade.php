                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="#"><i class="fa fa-phone"></i> +977-0101010101</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i>
                                    contact@mohss.com.np</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="#"><i class="fa fa-phone"></i>
                                    +977-0101010101</a></li>
                            <li class="text-right"><a href="#"><i class="fa fa-map-marker"></i>Xylem City, KTM</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            ...
                            <li><a href="#"><i class="fa fa-map-marker"></i> Xylem City, KTM</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    @if (Route::has('login'))
                        @auth
                            @if (Auth::user()->utype === 'ADM')
                                <li class="login-form"> <a href="index.php/register.html" title="Register">My Account
                                        (Admin)</a>
                                    <ul class="drop-down one-column hover-fade">
                        ...
                        @else
                            <li class="login-form"> <a href="{{ asset('register') }}" title="Register">Register</a>
                            </li>
                            <li class="login-form"> <a href="{{ asset('login') }}" title="Login">Login</a></li>
                    ...
                    <div class="row visible-md visible-lg">
                        ...
                        <div class="col-md-3 col-xs-6 col-sm-6">
                            ...
                            <ul class="social">
                                ...
                                <li class="twitter"><span><i class="fa fa-twitter"></i></span><a href="#"></a>
                                </li>
